...
class TestBrowser(curlwrapper.Browser):
    default_features = []
    default_others = []
    default_schemes = []

class TestBrowser2(curlwrapper.Browser):
    # XXX better name!
...
"""
    ...
    def _test_link_encoding(self, factory):
        import curlwrapper
        from curlwrapper._rfc3986 import clean_url
        url = "http://example.com/"
...
class ResponseTests(TestCase):
    ...
    def test_set_response(self):
        import copy
        from curlwrapper import response_seek_wrapper
    ...
    def test_str(self):
        import mimetools
        from curlwrapper import _response
